...
ax22.set_xlabel('Hydropower[GWh]   Average Deficit$\mathregular{[Mm^{3}]}$   Flood Reliability[%]   MEF Reliability[%]',position=(-0.12, 1e1),horizontalalignment='left', fontsize =14)
...
plt.xlabel("Average Deficit$\mathregular{ [Mm^{3}]}$", fontsize=14)
...
plt.tight_layout()
plt.savefig('parallelplot_withsubplot2.png', dpi = 1200)
