...
import sys
import NSD_objectives_optim_dailystoch_MEF
from NSD_objectives_optim_dailystoch_MEF import deterministic
import time
...
for j in range(nSeeds):
 ...
 runtime_filename = os.getcwd() + '/runtime2_stochMEF/' + 'runtime_file_seed_' + str(j + 1) + '.runtime'
